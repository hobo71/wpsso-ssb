...
if ( ! class_exists( 'WpssoSsbSubmenuShareEmail' ) ) {

	class WpssoSsbSubmenuShareEmail {
...
if ( ! class_exists( 'WpssoSsbShareEmail' ) ) {

	class WpssoSsbShareEmail {
    ...
    <span class="ssb-text"></span>
		...
		public function get_html( array $atts, array $opts, array $mod ) {
			...
			$email_excerpt = $this->p->page->get_caption( 'both', $opts['email_caption_max_len'], $mod, true,
				$atts['add_hashtags'], false, 'og_desc' );
