...
if ( ! class_exists( 'WpssoSsbSubmenuShareTumblr' ) ) {

	class WpssoSsbSubmenuShareTumblr {
		...
		public function filter_ssb_share_tumblr_rows( $table_rows, $form, $submenu ) {
...
if ( ! class_exists( 'WpssoSsbShareTumblr' ) ) {

	class WpssoSsbShareTumblr {
