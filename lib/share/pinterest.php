...
if ( ! class_exists( 'WpssoSsbSubmenuSharePinterest' ) ) {

	class WpssoSsbSubmenuSharePinterest {
...
if ( ! class_exists( 'WpssoSsbSharePinterest' ) ) {

	class WpssoSsbSharePinterest {
