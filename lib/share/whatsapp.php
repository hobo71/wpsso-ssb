...
if ( ! class_exists( 'WpssoSsbSubmenuShareWhatsApp' ) ) {

	class WpssoSsbSubmenuShareWhatsApp {
...
if ( ! class_exists( 'WpssoSsbShareWhatsApp' ) ) {

	class WpssoSsbShareWhatsApp {
