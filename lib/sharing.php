...
jQuery("#wpsso-ssb-sidebar-header").click( function(){ 
	jQuery("#wpsso-ssb-sidebar").toggle(); } );',
		...
		public function filter_post_cache_transient_array( $transient_array, $mod, $sharing_url, $mod_salt ) {
			...
			$transient_array['WpssoSsbSharing::get_buttons('.$mod_salt.')'] = $buttons_md5_pre;
			$transient_array['WpssoSsbShortcodeSharing::do_shortcode('.$mod_salt.')'] = $buttons_md5_pre;
			$transient_array['WpssoSsbWidgetSharing::widget('.$mod_salt.')'] = $buttons_md5_pre;
