...
if ( ! class_exists( 'WpssoSsbSubmenuWebsiteEmail' ) ) {
	...
	class WpssoSsbSubmenuWebsiteEmail {
		...
		public function filter_ssb_website_email_rows( $table_rows, $form, $submenu ) {
			...
			'<td colspan="2">'.$form->get_textarea( 'email_ssb_html', 'button_html code' ).'</td>';
...
if ( ! class_exists( 'WpssoSsbWebsiteEmail' ) ) {
  ...
  <a href="mailto:?subject=Share:%20%%email_title%%&body=%%email_excerpt%%%0D%0A%0D%0AShared%20from%20%%sharing_url%%%0D%0A">
    ...
    <span class="ssb-text"></span>
		...
		public function get_html( array $atts, array $opts, array $mod ) {
			...
			$email_excerpt = $this->p->page->get_caption( 'both', $opts['email_cap_len'], $mod, true, $atts['add_hashtags'], false, 'og_desc' );
