...
<p>WPSSO Social Sharing Buttons (aka WPSSO SSB) is an add-on for the WPSSO Core plugin. The WPSSO SSB Free add-on works with either the Free or Pro versions of WPSSO Core. The <a href="https://wpsso.com/extend/plugins/wpsso-ssb/">WPSSO SSB Pro add-on</a> uses WPSSO Core Pro features and requires an active and licensed <a href="https://wpsso.com/">WPSSO Core Pro plugin</a>.</p>
