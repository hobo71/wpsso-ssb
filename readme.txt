...
(2016/11/25) Refactored the Twitter button class and the min_version_notice() method. Fixed an incorrect variable name in the WhatsApp class. Fixed the Tumblr caption, title, and description attribute values.
